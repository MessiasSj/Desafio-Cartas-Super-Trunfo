...
int main(){
    ...
    // variasveis para comparação das cartas

    int compPopulacao, compArea, compPib, compTuristicos, compDensidadepop,
    compPib_percapita, compSuperPoder;
...
// Preenchimento dos dados da primeira carta
    ...
    compPib = pib1 > pib2;
    compTuristicos = turisticos1 > turisticos2;
    compDensidadepop = densidade_pop1 < densidade_pop2;
    compPib_percapita = pib_percapita1 > pib_percapita2;
